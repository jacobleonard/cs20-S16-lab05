# lab05Tests.py   SOLO, Jacob Leonard, jacobleonard@umail.ucsb.edu
...
class TestLab05Functions(unittest.TestCase): 
    ...
    def test_smallestInt_3(self):
       self.assertEqual( smallestInt([3]),  3)

    def test_smallestInt_4(self):
       self.assertEqual( smallestInt([4,5]),    4)

    def test_smallestInt_5(self):
       self.assertEqual( smallestInt([9,4,7,8,2]),    2)

    def test_smallestInt_6(self):
       self.assertEqual( smallestInt([9,4,2,8,11]),    2)
...
if __name__ == '__main__':
    ...
    #runTestsWithPrefix("lab05Tests.py","test_indexOfShortestString_") 
